...
public class MsgAPI {
    ...
    public static final String ACTION_SPRITER_APPEND_ANIMATION_RESOURCE = SANDBOX_PREFIX + "ACTION_SPRITER_APPEND_ANIMATION_RESOURCE";
    ...
    public static final String SPRITER_APPEND_ANIMATION = GLOBAL_PREFIX + "SPRITER_APPEND_ANIMATION";
}
